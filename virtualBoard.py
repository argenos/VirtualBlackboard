...
def main():
    ...
    while frame_number < total_frames:
        diff1 = Detector.diff_frame_hsv(bck_g1, cv.imread(files1[frame_number]), display=False, component=2)
        diff2 = Detector.diff_frame_hsv(bck_g2, cv.imread(files2[frame_number]), display=False, component=2)
